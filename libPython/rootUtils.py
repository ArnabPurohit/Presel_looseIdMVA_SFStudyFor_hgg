...
def histPlotter( filename, tnpBin, plotDir ):
    ...
    print '  get canvas: ' , '%s_Canv_pass' % tnpBin['name']
    c_pass = rootfile.Get( '%s_Canv_pass' % tnpBin['name'] )
    c_pass.Print( '%s/%s_pass.png' % (plotDir,tnpBin['name']))
    c_pass.SaveAs( '%s/%s_pass.pdf' % (plotDir,tnpBin['name']))
    print '  get canvas: ' , '%s_Canv_fail' % tnpBin['name']
    c_fail = rootfile.Get( '%s_Canv_fail' % tnpBin['name'] )
    c_fail.Print( '%s/%s_fail.png' % (plotDir,tnpBin['name']))
    c_fail.SaveAs( '%s/%s_fail.pdf' % (plotDir,tnpBin['name']))
