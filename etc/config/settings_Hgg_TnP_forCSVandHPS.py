...
if isPresel:
    if isEB:
        baseOutDir = 'June4/results_genmatch_Full2017_pt25and35/TnP_SF_passingElecveto_EB'
    else:
        baseOutDir = 'June4/results_genmatch_Full2017_pt25and35/TnP_SF_passingElecveto_EE'
else:
    if isEB:
